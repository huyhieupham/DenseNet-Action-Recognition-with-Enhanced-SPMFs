...
# Number of samples in AS1 [3762;2520].
...
generator = datagen.flow_from_directory('data/MSR-Action3D/AS1/validation',
                                        target_size=(32, 32),
                                        batch_size=1,
...
y_pred = model.predict_generator(generator,2205)
y_pred  = np.argmax(y_pred, axis=-1)
print (datetime.now()- start)
label_map = (train_generator.class_indices)
print(label_map)

y_true = np.array([0]*252 + [1]*252 + [2]*231 + [3]*231 + [4]*315 + [5]*315 + [6]*315 + [7]*294)
print(y_true.shape)
...
plt.title('DenseNet-BC (L=190, k=40) on MSR Action3D/AS1',fontsize=10, fontweight='bold',color = 'Gray')
