...
# Saving weight.
model.save_weights('output/Cross-View/DenseNet-16-NTU-CV.h5')
...
plt.savefig('output/Cross-View/Confusion-Matrix-DenseNet-16-NTU-CV.png')
...
plt.title('DenseNet-16 on NTU-RGB+D/Cross-View',fontsize=10, fontweight='bold',color = 'Gray')
...
# Save the figure.
plt.savefig('output/Cross-View/DenseNet-16-NTU-CV.png')
plt.show()
